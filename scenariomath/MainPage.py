...
html_footer = "<hr width=60% align=center><p align=center>--- yi zhang @ 2013 ---<br><a href=https://github.com/yizhangid/knowledgeinscript/tree/master/scenariomath> source code for this entire site in github<a> </p></body></html>"
app = webapp2.WSGIApplication([('/', MainPage)], debug=True) 
app.router.add((r'/cmd', 'cmd_scenario.CommandLineTool'))
app.router.add((r'/generic', 'generic_scenario.GenericTool'))
app.router.add((r'/ajax','ajax.AjaxExample'))
